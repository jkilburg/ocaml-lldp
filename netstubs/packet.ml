...
external add_membership  : int -> int -> string -> (unit,int) Result.t = "packet_add_membership_c"
external drop_membership : int -> int -> string -> (unit,int) Result.t = "packet_drop_membership_c"
